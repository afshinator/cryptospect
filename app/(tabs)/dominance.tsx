...
export default function DominanceScreen() {
  ...
  const dynamicAxisColor = colorScheme === 'dark' 
  ...
  if (firstDate.getMonth() === lastDate.getMonth() && firstDate.getFullYear() === lastDate.getFullYear()) {
    monthLabel = firstDate.toLocaleDateString('en-US', { year: 'numeric', month: 'long' });
  } else {
  ...
  // 3. Extract Latest Values for display (passed to new component)
      ...
      <ThemedView style={styles.container}>
        ...
        <ThemedView>
          <LineChart
            ...
            bezier 
            // This is the key change to ensure no area fill/shadow is applied
            withShadow={false} 
        ...
        {/* LATEST SNAPSHOT - Using the new component */}
